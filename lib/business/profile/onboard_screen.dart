...
class OnboardScreen extends ConsumerWidget {
      ...
      body: IntroductionScreen(
        ...
        pages: [
          ...
          PageViewModel(
            ...
            image: Image.asset(getFilename(themeMode)),
          ),
          PageViewModel(
            decoration: pageDecoration,
            title: "数独的玩法",
  ...
  String getFilename(ThemeMode themeMode) {
    return themeMode == ThemeMode.dark ? "assets/image/sudoku_dark.png" : "assets/image/sudoku_light.png";
  }
}
